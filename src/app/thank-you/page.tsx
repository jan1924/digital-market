      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          <div className="lg:col-start-2">
            ...
            <h1 className="mt-2 text-4xl font-bold tracking-tight text-gray-900 lg:text-5xl">
              Thanks for ordering
            </h1>
            {order._isPaid ? (
            ...
            <div className="mt-16 text-sm font-medium">
              ...
              <ul className="mt-6 divide-y divide-gray-100 border-t border-gray-200 text-sm font-medium text-muted-foreground">
              ...
              <div className="mt-16 border-t border-gray-400 py-6 text-right">
                <Link
                  href="/products"
                  className="text-sm font-medium text-blue-600 hover:text-blue-500"
                >
                  Continue shipping &rarr;
                </Link>
              </div>
            </div>
          </div>
